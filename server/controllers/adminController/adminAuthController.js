...
router.get("/google/callback", async (req, res) => {
  try {
    ...
    const jwtToken = jwt.sign({ id: admin.id, email: admin.email, name: admin.name, role: "admin" }, process.env.JWT_SECRET, { expiresIn: "7d" })
    ...
    res.status(500).send("Admin auth failed")
  }
})
